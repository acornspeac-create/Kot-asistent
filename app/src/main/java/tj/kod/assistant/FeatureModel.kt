...
object KotTasks {
    val all = listOf(
        ...
        KotTask("code", "Программист", "Генерация, разбор, создание файлов и изменение проекта"),
        KotTask("core", "Ядро / Улучшить себя", "Изменение критичных файлов KOT, сборка и откат"),
